...
const _lazy_HBm2AH = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_HBm2AH, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_HBm2AH, lazy: true, middleware: false, method: undefined }
];
